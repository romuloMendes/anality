...
@section('title', 'Importar Ataques - Anality')
        ...
        <div class="row">
            <div class="col-lg-8 mx-auto">
                ...
                <div class="page-header mb-4">
                    ...
                    <h1 class="page-header-title">Importar Ataques</h1>
                    <p class="page-header-sub">upload de arquivo JSON para ingestão de incidentes</p>
                </div>
                        ...
                        <form action="{{ route('attacks-import.process') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="alert alert-info mb-4">
                                ...
                                <ul class="mb-2" style="font-size:12px;">
                                    ...
                                    <li><strong>summary</strong> — Descrição / conteúdo</li>
                                    <li><strong>date</strong> — Data (ex: <code>31.dez.2022 às 23h15</code>)</li>
                                </ul>
                                <pre class="mb-0 p-2"
                                    style="font-size:11px;background:rgba(0,229,255,0.04);border:1px solid rgba(0,229,255,0.15);border-radius:4px;">[
  {"title": "Nome do ataque", "summary": "Descrição...", "date": "31.dez.2022 às 23h15"}
]</pre>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div id="dropzone" class="rounded p-5 text-center" style="cursor: pointer;">
                                    ...
                                    <p class="mb-0"
                                        ...
                                        ou clique para selecionar &nbsp;|&nbsp; JSON, TXT &nbsp;|&nbsp; máx. 50 MB</p>
                                </div>
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <ul class="mb-0" style="font-size:12px;color:var(--text);font-weight:300;">
                            ...
                            <li>Ataques duplicados serão ignorados automaticamente</li>
                            <li>Máximo de 50 MB por arquivo</li>
                        </ul>
                    </div>
                </div>
            ...
            document.getElementById('importForm').addEventListener('submit', function(e) {
                ...
                xhr.upload.addEventListener('progress', e => {
                    if (e.lengthComputable) {
                        setProgress((e.loaded / e.total) * 80, 'Enviando arquivo...',
                ...
                xhr.open('POST', '{{ route('attacks-import.api') }}');
