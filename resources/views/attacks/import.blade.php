    ...
    <div class="container my-5">
        <div class="row">
            <div class="col-lg-8 mx-auto">
                <div class="mb-5">
                    <h1 class="h2 mb-2"><i class="bi bi-shield-exclamation"></i> Importar Ataques</h1>
                ...
                area.innerHTML = `
                    <div class="alert alert-success alert-dismissible fade show mt-4">
                        ...
                        <div class="row text-center mt-3">
                            <div class="col-4"><h5 class="text-success mb-0">${data.imported}</h5><small>Importados</small></div>
                            <div class="col-4"><h5 class="text-danger mb-0">${failed}</h5><small>Falhados</small></div>
