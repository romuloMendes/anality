            ...
            <div class="col-lg-8 mx-auto">
                    ...
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        ...
                        @if (session('import_result'))
                            <div class="row text-center mt-3">
                                <div class="col-4"><div style="color:var(--ok)"><h5>{{ session('import_result.imported') }}</h5><small>Importados</small></div></div>
                                <div class="col-4"><div style="color:var(--danger)"><h5>{{ session('import_result.failed') }}</h5><small>Falhados</small></div></div>
                                <div class="col-4"><div style="color:var(--accent)"><h5>{{ session('import_result.total') }}</h5><small>Total</small></div></div>
                            </div>
                        @endif
                ...
                <div class="card">
                    <div class="card-body p-4">
                        <form action="{{ route('attacks-import.process') }}" method="POST" enctype="multipart/form-data" id="importForm">
                            @csrf
                            ...
                            <div class="alert alert-info mb-4">
                                ...
                                <pre class="mb-0 p-2" style="font-size:11px;background:rgba(0,229,255,0.04);border:1px solid rgba(0,229,255,0.15);border-radius:4px;">[
  {"title": "Nome do ataque", "summary": "Descrição...", "date": "31.dez.2022 às 23h15"}
                            ...
                            <div class="mb-4">
                                ...
                                <div id="dropzone" class="rounded p-5 text-center" style="cursor: pointer;">
                                    ...
                                    <p class="mb-0" style="color:var(--muted);font-size:11px;font-family:'Share Tech Mono',monospace;">ou clique para selecionar &nbsp;|&nbsp; JSON, TXT &nbsp;|&nbsp; máx. 50 MB</p>
                                </div>
        ...
        document.getElementById('importForm').addEventListener('submit', function(e) {
            ...
            xhr.upload.addEventListener('progress', e => {
                if (e.lengthComputable) {
                    setProgress((e.loaded/e.total)*80, 'Enviando arquivo...', `${(e.loaded/1048576).toFixed(1)} MB de ${(e.total/1048576).toFixed(1)} MB`);
                }
            });
